...
* Minimal starter code is provided for this assignment, but be sure to grab it
from GitHub
...
pull the starter code for this assignment.
...
1. BST Public Methods: Include at least 5 test cases for each public member function of your BST class, including `insert()`, `remove()`, `contains()`, and any print/display method. Test cases should cover:
